...
import org.hibernate.resource.jdbc.internal.CallableQueryPreparedStatementBuilderImpl;
 ...
 */
public class CallableQueryPreparedStatementBuilderImplTest
		...
		setMethodCallCheck(
				new ConnectionMethodCallCheck() {
					...
					public void verify(Connection c, String expectedSql) throws SQLException {
						Mockito.verify( c ).prepareCall( expectedSql );
						reset( c );
					}
