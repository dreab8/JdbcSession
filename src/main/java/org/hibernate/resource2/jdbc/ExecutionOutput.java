...
public interface ExecutionOutput {
	...
	/**
	 * An unwrapping (casting) API
	 *
	 * @param type The type to unwrap/cast to.
	 * @param <T> The unwrap type
	 *
	 * @return The unwrapped/cast result.
	 */
	public <T extends ExecutionOutput> T as(Class<T> type);
}
