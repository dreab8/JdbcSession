 ...
 */
public abstract class AbstractLogicalConnectionImpl implements LogicalConnection, PhysicalJdbcTransaction {
	private static final Logger log = Logger.getLogger( AbstractLogicalConnectionImpl.class );
